...
scrna_df = read.csv('allen_institute_tables/cell_type_specific_expression_superclass.csv')
...
write.csv(stats, 'statistics/fishers_exact_with_R_superclass.csv', row.names=F)
