...
df = pd.read_csv('16p12_cohort.expansions_2SD.annotated.exonic.csv')
...
df[(df['Gene.wgEncodeGencodeBasicV19'] != df['Gene_symbol'])][['Gene.wgEncodeGencodeBasicV19','Gene_symbol']]
...
#++++++++++++++++++++++++++++++++++++
# This is no longer needed because I fixed it in Script 10

# sometimes the gene column has the same gene 
# listed twice and seperated by semicolon
# for example (PROCA1;PROCA1)
# In these cases replace with just PROCA1
# def remove_duplicates(s):
# 	genes = s.split(';')
# 	genes = list(set(genes))
# 	return ';'.join(genes)
# df['Gene'] = df['Gene'].apply(remove_duplicates)
#++++++++++++++++++++++++++++++++++++
...
df.to_csv('16p12_cohort.expansions_2SD.annotated.exonic.gene_ids.csv', index=False)
