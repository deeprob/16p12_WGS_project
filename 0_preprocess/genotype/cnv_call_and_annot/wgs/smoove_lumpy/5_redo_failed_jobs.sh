...
#SBATCH -o logs/5_redo_regenotype/%a.log
#SBATCH -o logs/5_redo_regenotype/%a.log
#SBATCH --ntasks=1
...
#SBATCH --array=127,149,189,271,273,274,276,278,281,283,311,318,344
#SBATCH --nodelist qingyu



# set array to jobs that need be redone in 3_failed_jobs.txt
# I increased memory from 5GB to 20Gb
