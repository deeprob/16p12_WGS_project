...
bedtools intersect -a bed_files/8.1_nejm_dels.bed -b /data5/16p12_WGS/structural_variants/sv_caller_postprocessing/2022_02_14/cnv_controls_hg19_dels.txt -f 0.5 -r -c > bed_files/9.2_nejm_dels.bed

# Finally, annotate for intracohort frequency
bedtools intersect -a bed_files/9.2_nejm_dels.bed -b bed_files/9.2_nejm_dels.bed -f 0.5 -r -c > bed_files/9.3_nejm_dels.bed
...
# Microarray controls
bedtools intersect -a bed_files/8.1_nejm_dups.bed -b /data5/16p12_WGS/structural_variants/sv_caller_postprocessing/2022_02_14/cnv_controls_hg19_dups.txt -f 0.5 -r -c > bed_files/9.2_nejm_dups.bed
# Intracohort frequency
bedtools intersect -a bed_files/9.2_nejm_dups.bed -b bed_files/9.2_nejm_dups.bed -f 0.5 -r -c > bed_files/9.3_nejm_dups.bed
