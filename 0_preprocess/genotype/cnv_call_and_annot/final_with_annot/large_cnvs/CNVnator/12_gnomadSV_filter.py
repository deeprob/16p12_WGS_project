...
# Dels
lookup = pd.read_csv('bed_files/11_gnomadSV_anno_dels.bed', sep = '\t')
dels = pd.read_csv('bed_files/10_dels_frequency_filter.bed', sep = '\t')
...
dels.to_csv('bed_files/12_gnomadSV_filter_dels.bed', index = False, sep = '\t')

# Dups
lookup = pd.read_csv('bed_files/11_gnomadSV_anno_dups.bed', sep = '\t')
dups = pd.read_csv('bed_files/10_dups_frequency_filter.bed', sep = '\t')
dups = dups.apply(get_AFs, axis = 1)
dups = dups[dups.gnomADSV_AFfilter]
dups.to_csv('bed_files/12_gnomadSV_filter_dups.bed', index = False, sep = '\t')
