...
while not df1.equals(df2):
	df2.to_csv('intermediate_files/3_adjacent_filter/'+str(sample)+'_'+str(counter)+'.txt', index = False, sep = '\t')
...
df2.to_csv('bed_files/3_adjacent_filter/'+str(sample)+'_delly_final.bed', index = False, sep = '\t')
