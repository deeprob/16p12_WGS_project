...
# <-------->                <---------------> CNV
#             <---->                          STR
bedtools intersect -wa -a bed_files/7_brandler_filter.bed -b ../../2022_02_14/hg19_ver13_1.bed -v -header > bed_files/8.1_str_no_overlap.bed
# (b) CNVS that overlap the STR regions 100%
# <-----------------------> CNV
#    <--->                  STR
bedtools intersect -wa -a bed_files/7_brandler_filter.bed -b ../../2022_02_14/hg19_ver13_1.bed -F 1 -u -header > bed_files/8.2_str_all_overlap.bed
