...
#SBATCH --chdir /data5/16p12_WGS/annotations/2022_01_31/
...
INPUT_VCF=/data5/16p12_WGS/annotations/2022_01_27/vcfs/filter1/$SAMPLE.vcf.gz
OUTPUT_PREFIX=/data5/16p12_WGS/annotations/2022_01_31/vcfs/annovar_genes/$SAMPLE
...
perl /data4/software/annovar/table_annovar.pl $INPUT_VCF /data5/bx_reference/hg19/annotations/annovar \
 -buildver hg19 \
 -out $OUTPUT_PREFIX \
 -remove \
