...
INPUT_VCF=/data5/16p12_WGS/annotations/2022_02_04/exonic_vcfs/filter2/$SAMPLE.vcf.gz
OUTPUT_VCF=/data5/16p12_WGS/annotations/2022_02_04/exonic_vcfs/cadd/$SAMPLE.vcf.gz
...
vcfanno_linux64.1 /data5/16p12_WGS/annotations/2022_02_04/cadd.toml $INPUT_VCF | bgzip > $OUTPUT_VCF
