...
df = pd.read_csv('exonic_variants/rare_deleterious_exonic_variants_cohort_count_gene_ids_loeuf.csv')
...
df.to_csv('exonic_variants/rare_deleterious_exonic_variants_cohort_count_gene_ids_loeuf_omim.csv', index=False)
