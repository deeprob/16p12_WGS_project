...
df = pd.read_csv('exonic_variants/rare_deleterious_exonic_variants_cohort_count.csv')
...
df.to_csv('exonic_variants/rare_deleterious_exonic_variants_cohort_count_gene_ids.csv', index=False)
