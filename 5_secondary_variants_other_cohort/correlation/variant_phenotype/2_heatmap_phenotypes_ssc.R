...
groups = c('dbd_tier1_snvs', 'large_rare_deletions', 'large_rare_duplications', 'nejm_deletions', 'nejm_duplications')
variant_cols = c('Missense CADD>25', 'Missense CADD25 LOEUF<0.35', 'LOF CADD25_NA', 'LOF CADD LOEUF<0.35', 'Splice CADD25', 'Splice CADD25 LOEUF<0.35', 'Genes DEL', 'Genes DUP', 'DELs LOEUF<0.35', 'DUPs LOEUF<0.35',	'STRs exonic',	'STRs exonic LOEUF<0.35', 'Rare_Deleterious_SNVs', 'Rare_Deleterious_SNVs_LOEUF', 'intelligence_PRS', 'SCZ_PRS', 'educational_attainment_PRS')
pheno_cols = c('Full_scale_IQ','SRS_raw','DCDQ', 'ABCL_CBCL_external','ABCL_CBCL_internal','RBS_R', 'BMI_zscore')
