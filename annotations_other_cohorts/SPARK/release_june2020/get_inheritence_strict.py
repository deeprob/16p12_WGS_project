...
infilename = 'vcfs/formatted/ssc_release_june_2020.select_annotations.txt'
...
for line in f:
    ...
    mother_vcf_filename = '/data5/SPARK_WES/Variants/GATK/gvcf_individual/{}/{}.gvcf.gz'.format(mother[-1], mother)
    ...
    father_vcf_filename = '/data5/SPARK_WES/Variants/GATK/gvcf_individual/{}/{}.gvcf.gz'.format(father[-1], father)
