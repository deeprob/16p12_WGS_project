...
stats_df <- data.frame(Variant=character(0), Phenotype=character(0), Pvalue=numeric(0), Num_samples=numeric(0), Partial_Omega_Sq=numeric(0))
...
write.csv(stats_df, 'statistics/anova_phenotypes.csv', row.names=F)
