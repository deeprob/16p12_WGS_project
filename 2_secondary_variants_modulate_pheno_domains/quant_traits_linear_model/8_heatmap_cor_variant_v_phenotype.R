...
df = read.csv('statistics/correlation_phenotypes.csv', check.names=F)
...
title_text = glue('Pearson\'s R ({min_num_samples}-{max_num_samples} Samples)')
...
corrplot(
		...
		na.label="-",
	 	title=title_text,
	 	col = colorRampPalette(c("#053061", "#2166AC", "#4393C3", "#92C5DE", "#D1E5F0", "#F7F7F7", "#FDDBC7", "#F4A582", "#D6604D", "#B2182B", "#67001F"))(20),
	 	is.corr=F,
