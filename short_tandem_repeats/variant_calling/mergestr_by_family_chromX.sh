...
#SBATCH -o logs/mergestr_by_family_chrX/submit.log
#SBATCH -e logs/mergestr_by_family_chrX/submit.err
#SBATCH --ntasks=1
...
out_dir=/data5/16p12_WGS/structural_variants/vcf_callers/output/mergestr_by_family_chrX
...
for fam in $families
do
append_vcf=output/dumpstr_by_family_chrX/dumpstr.${fam}.vcf.gz
